...
if (-not $Env:HF_ENDPOINT) {
    ...
    Write-Output "Using default HF_ENDPOINT: $Env:HF_ENDPOINT"
} else {
     Write-Output "Using default HF_ENDPOINT: $Env:HF_ENDPOINT"
}
...
if (-not $Env:UV_EXTRA_INDEX_URL) {
    ...
    Write-Output "Using default UV_EXTRA_INDEX_URL: $Env:UV_EXTRA_INDEX_URL"
} else {
    Write-Output "Using existing UV_EXTRA_INDEX_URL: $Env:UV_EXTRA_INDEX_URL"
}
